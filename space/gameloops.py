...
#level page
def level(screen,back_button,bg,bg2,level_text,level_textRect,dataJson,button_l1,button_l2,button_l3,button_l4,button_l5,button_l6,button_l7,button_l8,px,py):
...
def Game(counter,enemycount,initEnemyCount,game_state,lvl,gameovertick,bgm,screen,explosion_group,bulletGroup,PlayerbulletGroup,EnemyGroup,pl,enemy,Enemyship1,Enemyship2,ScreenState,draw_text,white,px,py,dataJson,font,font2,home_button,back_button,bg3,blue):
    ...
    if game_state=="won":
        ...
        screen.fill((0,20,0))
        draw_text("Game Over",blue,500*px,20*py,int(py*70))
        draw_text("Score:"+str(pl.enemyTakedown),white,500*px,200*py,int(py*30))
