...
ship2 = pygame.image.load("Assets/Ships/Ship2.png")
ship2 = pygame.transform.scale(ship2,(125*px,125*py))
...
class bullet(pygame.sprite.Sprite):
    def __init__(self,image,speed,x,y,dam,targetX,targetY,dy,entity):
        ...
        self.entity=entity
        self.r=math.degrees(math.atan(self.xChange/self.yChange))
        self.img=pygame.transform.rotate(self.img,self.r)
...
async def main():
    ...
    while running:
        ...
        if ScreenState=="Home":
            ...
            ScreenState,levelChoise,enemycount=gameloops.level(screen,back_button,bg,bg2,level_text,level_textRect,dataJson,button_l1,button_l2,button_l3,button_l4,button_l5,button_l6,button_l7,button_l8,px,py)
            lvlEnemyCont=enemycount
            pl.abilityLoader=0
        elif ScreenState=="shop":
            ScreenState=gameloops.shop(screen,back_button,bg)
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key==pygame.K_SPACE:
                        if pl.shootCooldown==0:
                            blt=Plbullet(bullet1,3,pl.xpos,pl.ypos)
